...
int main() {
    ...
    do {
        ...
        cout << "\t3. Remove Next Creature.\n"; // Additional option to remove the next creature
        cout << "\t4. End Program.\n";
...
void deleteCreature(ArrayMinHeap *creatureHeap) {
    ...
    bool creatureRemoved = creatureHeap->remove(removedCreature);

    if (creatureRemoved) {
        cout << "Creature removed:\n";
        cout << "Name: " << removedCreature.getName() << "\n";
    } else {
        cout << "No creatures to remove. The heap is empty.\n";
    }
}
